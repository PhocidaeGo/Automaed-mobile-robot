...
4. **Launch Map Processor**:
   ...
   TODO 1: use the functions of planes to draw lines that can be easily detected by CGAL while generator less noise.
   (Finished)
   ...
   TODO 3: use image compressed from original cloud and a mask generated by filtered cloud to detection.
   (Current)
