...
4. **Launch Map Processor**:
   ...
   **TODO 5**: *(Current)* The RANSAC method may have difficulties dealing with maps from different equipments(lidars). Need to fine-tune the distance parameters each time.
